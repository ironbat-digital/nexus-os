...
es un **stub de frontera pública**: el Hub es el control plane hospedado **propietario** y su spec de
desarrollo web no forma parte de este repo OSS (implementación: <https://github.com/ironbat-digital/nexus-hub>).
...
| b | [Nexus Hub (frontera)](b-nexus-hub.md) | Frontera pública del Hub hospedado **propietario**: rol, responsabilidades, no-objetivos y contratos que emite/consume. Implementación fuera del OSS. |
